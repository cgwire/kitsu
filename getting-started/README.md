...
Now is time to assigned artist! 

On the assets page, click on the empty space on the right of a status on the asset you want to assign.

A new blue line on top of the screen appears. You can add the assignation. Just tape the name of the artist, it has autocompletion, and as soon as you click on the box you will see the list of the people.
...
Now to add more shot, as you can see the box is already fill with your name code but incremented, so you just have to continue to click on add, to create more shots.
...
on the new window you can enter the In and Out of the shot, you can enter it by hand or use the + and - button.
Save with the "Confirm" button. Now the framerange appear on the general spreadsheet of the shot page.
...
You can now do you selection, with "crtl" of "shift" and choose the new status for your selected tasks. Validated the new status with the "Confirm" button.

	Priority

At some point on the production you may want to prioritized some tasks, and pintpoint theses urgent tasks to your team.
