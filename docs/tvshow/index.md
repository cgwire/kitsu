...
[See Getting Started With Kitsu](../configure-kitsu/index.md)
:::
...
::: tip
You can also customize the asset type list and the task pipeline. [See Asset Types Workflow](../configure-kitsu/index.md#specific-asset-types-workflow)
:::
...
First, ensure that the missing task type is added in the settings page under the task type tab (otherwise, [See Getting Started with Kitsu](../configure-kitsu/index.md)).
...
4. **CSV Import:** You can also utilize CSV Import to swiftly update your frame ranges. [Update Shots information with CSV Import](#update-your-shots)
...
 [See How to Create a New Task Type](../configure-kitsu/index.md#studio-workflow-create-a-new-task-type)
...
[See How to Create Status Automation](../configure-kitsu/index.md#automation)
