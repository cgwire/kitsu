...
Then, 6 is the option parts. If you already have a spreadsheet with your asset.
...
If on the contrary, you realize you need the **shots**, you need to also switch your production type fom **Only Assets** to **Short**.
:::
...
main asset, and we are sure to omit nothing.
...
the middle section, it is your selection for the asset (2).
...
You can also choose multiple assets at the same time. Click on the first asset, hold the **shift** key, and click on the last asset of your selection.
...
If a new asset is created during the a task, return to the asset
