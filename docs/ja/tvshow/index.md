...
[Kitsuの入門ガイド](../configure-kitsu/index.md)を参照してください。
:::
...
::: ヒント
アセットタイプのリストとタスクパイプラインはカスタマイズすることもできます。 [アセットタイプのワークフローを参照](../configure-kitsu/index.md#specific-asset-types-workflow)
:::
...
まず、不足しているタスクタイプが設定ページのタスクタイプタブに追加されていることを確認してください（そうでなければ、[Kitsuの使い方](../configure-kitsu/index.md)を参照）。
...
[Kitsuの使い方](../configure-kitsu/index.md)を参照してください。
:::
...
4. **CSV インポート:** フレーム範囲を素早く更新するには、CSV インポートも利用できます。 [CSV インポートでショット情報を更新](#update-your-shots)
...
[ステータス自動化の作成方法](../configure-kitsu/index.md#automation)を参照
