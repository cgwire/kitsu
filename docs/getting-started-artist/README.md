...
![Artist board page comment panel](../img/getting-started/artist_board_page_comment.png)
...
![Artist board page drag](../img/getting-started/artist_board_page_drag.png)
...
![Artist board page wfa](../img/getting-started/artist_board_page_review.png)
...
![My tasks calendar page](../img/getting-started/artist_calendar_page.png)


If you click on the task, the comment panel on the right will open as usual.

![Artist calendar page comment panel](../img/getting-started/artist_calendar_page_panel.png)
