...
See the [Studio Workflow](../configure-kitsu/index.md#studio) section.
:::
...
[Import asset](../feature/index.md#create-an-asset)

[Import shot](../feature/index.md#create-shots-from-an-edl-file)
...
 [Update Shots information with CSV Import](../feature/index.md#update-your-shots)
