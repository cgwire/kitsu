...
See the [Studio Workflow](../configure-kitsu/index.md#studio-workflows) section.
:::
...
[Import asset](../videogame/index.md#create-an-asset)

[Import map](../videogame/index.md#create-maps-from-an-edl-file)
...
[Customization of the workflow](../configure-kitsu/index.md#asset-types)) for more details
:::
...
![Drop down menu map](../img/getting-started/drop_down_menu_shot.png)
...
![map edit page](../img/getting-started/shot_edit.png)
...
 [Update maps information with CSV Import](../videogame/index.md#update-your-maps)
...
[Creating a New Task Type](../configure-kitsu/index.md#task-types)
