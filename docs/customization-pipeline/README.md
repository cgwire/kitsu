...
Only the Studio manager has access to it. The second is the production library, where you will pick elements created on the global library to fill it.
...
Now your next task is created on your global library. You need to add it to your production library to be able to use it.
...
Click on **Confirm** to save your changes. Now your changes are applied on all the production the task type is used.
...
Now your new **Asset Type** is created on your global library. You need to add it to your production library to be able to use it.
...
Click on **Confirm** to save your changes.
 ...
 Your changes are applied to all the productions, and the **asset type** is used.
...
Now your new **Status Automation** is created on your global library. You need to add it to your production library to be able to use it.
