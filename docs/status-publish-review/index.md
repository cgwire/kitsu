...
[Update Shots information with CSV Import](../feature/index.html#update-your-shots)
...
[Perform a review](../getting-started-client/index.html#perform-a-review)), with the **draw** button ![draw button](../img/getting-started/draw.png)
