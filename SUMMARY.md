...
* [Getting Started as a Production Manager](getting-started-production/README.md#first-steps)
    * [Create your first production](getting-started-production/README.md#create-your-first-production)
    * [Create some assets](getting-started-production/README.md#create-some-assets)
    * [Add a CG Artist to the team](getting-started-production/README.md#add-a-cg-artist-to-the-team)
    * [Assign tasks to a CG Artist](getting-started-production/README.md#assign-tasks-to-a-cg-artist)
    ...
    * [Set frame ranges](getting-started-production/README.md#add-the-frameranges)
    * [Do batch validations](getting-started-production/README.md#validation-per-batch)
    * [Change priorities](getting-started-production/README.md#change-priorities)
    * [Perform a review](getting-started-production/README.md#perform-a-review)
    
* [Getting Started as a CG Artist](getting-started-artist/README.md#first-connection)
    * [See your assignments](getting-started-artist/README.md#see-your-assignments)
