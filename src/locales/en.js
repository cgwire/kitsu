export default {
  ...
  productions: {
    ...
    creation: {
      ...
      placeholder_fps: 'xx',
      placeholder_ratio1: 'y',
      placeholder_ratio2: 'z',
      placeholder_resolution1: 'xxxx',
      placeholder_resolution2: 'yyyy',
      production_settings: 'Set your production settings',
      production_settings_description: 'Set all essential production settings.',
      select_asset_task_type: 'Select asset task type',
      select_asset_task_type_description: 'These task types define what you track the process during the asset stage.',
