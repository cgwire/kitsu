export default {
  ...
  status_automations: {
    ...
    delete_error: 'An error occurred while deleting this status automation. It may be linked to a . If so, you must remove it from every production first.',
  ...
  project_templates: {
    ...
    number: 'template | production templates',
  ...
  notifications: {
    ...
    no_notifications: 'There are currently no notifications for you for your current s.',
  ...
  people: {
    ...
    empty_team: 'There is no one listed in the  team.',
  ...
  playlists: {
    ...
    no_playlist: 'There are currently no playlists for this  or episode.',
  ...
  productions: {
    ...
    delete_text: 'Are you sure you want to remove {name} from your database? Please, confirm by typing the name of the  you want to delete in the text field.',
    ...
    creation: {
      ...
      add_asset_types_description: 'Add asset types to your ',
      ...
      choose_template: 'Apply a  template (optional)',
    ...
    metadata: {
      add_explaination: 'Add specific data required by this .',
      add_failed: 'An error occurred while adding metadata to your .',
  ...
  tasks: {
    ...
    create_tasks_shot_explaination: 'You are about to create a new task for each shot of the current  for the given task type. Do you want to continue?',
    ...
    create_tasks_asset_explaination: 'You are about to create a new task for each asset of the current  for the given task type. Do you want to continue?',
    ...
    create_tasks_edit_explaination: 'You are about to create a new task for each edit of the current  for the given task type. Do you want to continue?',
    ...
    create_tasks_episode_explaination: 'You are about to create a new task for each episode of the current  for the given task type. Do you want to continue?',
    ...
    create_tasks_sequence_explaination: 'You are about to create a new task for each sequence of the current  for the given task type. Do you want to continue?',
  ...
  timesheets: {
    ...
    export_timespents: 'Export time spent entries for open s as a list',
    hours: 'hours',
    month: 'Month',
    off: 'Off',
