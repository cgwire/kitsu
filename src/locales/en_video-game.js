...
export default {
  ...
  episodes: {
    ...
    empty_list_read_only: 'There is no chapter in this production.',
    new_episode: 'New chapter',
    new_episodes: 'Create chapters',
  ...
  sequences: {
    ...
    empty_list_read_only: 'There is no level in this production.',
    new_sequence: 'New level',
    new_sequences: 'Create levels',
  ...
  shots: {
    ...
    empty_list_read_only: 'There is no map in this production.',
    episodes: 'Chapters',
