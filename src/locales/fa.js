export default {
  ...
  login: {
    ...
    reset_change_password_form_failed:
      'رمز وارد شده معتبر نیست. رمز وارد شده باید حداقل 8 کاراکتر و هردو باهم تطابق داشته باشند.',
  ...
  profile: {
    ...
    change_password: {
      ...
      unvalid:
        'رمز جدید شما یا باهم مطابقت ندارد ویا کوتاه است (رمز باید حداقل 8 کاراکتر باشد).'
    },
    save: {
